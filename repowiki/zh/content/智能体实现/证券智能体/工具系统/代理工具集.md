...
## 更新摘要
**变更内容**
- 更新了股票搜索工具的实现方式，从之前的 '[stock-search]' 迁移到 '--group securities'
- 新增了完整的股票搜索服务架构说明，包括 StockSearchService、StockLoader、MultiPathMatcher 等组件
- 补充了股票搜索工具的技术实现细节和使用场景
- 更新了工具组组织方式和依赖关系
...
**更新** 本次更新重点反映了股票搜索功能从 '[stock-search]' 到 '--group securities' 的重大迁移，新增了完整的股票搜索服务架构和实现细节。
...
**更新** 新增了股票搜索服务组件，包括 StockSearchService、StockLoader、MultiPathMatcher 等核心组件。
...
**更新** 重新实现了股票搜索功能，从之前的 '[stock-search]' 迁移到 '--group securities'，采用全新的 StockSearchService 架构。
...
**更新** 新增了股票搜索服务的依赖关系，包括 StockSearchService、StockLoader、MultiPathMatcher 等组件的协作关系。
...
**更新** 本次更新重点强化了股票搜索功能的实现，从 '[stock-search]' 迁移到 '--group securities'，采用了全新的 StockSearchService 架构，提供了精确代码匹配、中文名称模糊匹配、拼音/首字母匹配和错别字纠错等强大功能，显著提升了用户体验和查询准确性。
...
**更新** 新增了股票搜索工具的详细职责说明，包括支持的匹配方式和使用场景。