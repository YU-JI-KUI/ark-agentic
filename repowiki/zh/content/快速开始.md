...
## 项目结构
仓库采用“核心框架 + 业务智能体 + API 服务 + CLI 脚手架”的组织方式，便于二次开发与扩展。
...
**图表来源**
- [src/ark_agentic/app.py: 44-51:44-51](file://src/ark_agentic/app.py#L44-L51)
...
## 架构总览
下面的架构图展示了从客户端请求到智能体执行、工具调用与流式输出的关键路径。
...
## 结论
Ark-Agentic 提供了从工具、技能、会话、记忆到流式输出的一体化能力，配合 FastAPI 与 CLI 脚手架，能够快速搭建生产级智能体应用。通过保险与证券示例，开发者可以迅速理解如何创建智能体、配置工具与技能，并通过 /chat 端点进行交互与流式输出。
