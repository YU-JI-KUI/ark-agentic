"""Alembic env for the notifications feature schema.
...
temp connection and ``NotificationsBase.metadata`` is loaded from imports
for autogenerate.
"""
...
if target_metadata is None:
    from ark_agentic.plugins.notifications.storage.models import (
        NotificationsBase,
    )

    target_metadata = NotificationsBase.metadata
